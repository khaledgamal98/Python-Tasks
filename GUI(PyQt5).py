from PyQt5.QtWidgets import QMainWindow,QApplication,QDesktopWidget,QPushButton,QLineEdit,QWidget,QGridLayout,QGroupBox,QVBoxLayout,QMessageBox
import sys
...
class GUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Plotting Graphs")
        self.setGeometry(400,400,400,400)
        self.setMinimumHeight(200)
        self.setMinimumWidth(200)
        self.setMaximumHeight(600)
        self.setMaximumWidth(800)
        self.equation_line_edit=QLineEdit(self)
        self.minimum_line_edit=QLineEdit(self)
        self.maximum_line_edit=QLineEdit(self)
        self.layout()
        vbox=QVBoxLayout()
    ...
    def centering_window(self):
        ...
        window_geometery.moveCenter(center_point) # move window(rectangle) center point to the screen center point
        self.move(window_geometery.topLeft())   # top left of rectangle becomes top left of window centering it
    def layout(self):
        self.group_message=QGroupBox("Please fill the following spaces") # Object for QGroupBox
        self.group_message.setFont(QtGui.QFont("Decorative", 14))
        grid_layout=QGridLayout()           #object for QGridLayout
        button1=QPushButton("Equation",self)
        grid_layout.addWidget(button1,0,0)
        grid_layout.addWidget(self.equation_line_edit,0,1)
        button2=QPushButton("Minimum Value of x",self)
        grid_layout.addWidget(button2,1,0)
        grid_layout.addWidget(self.minimum_line_edit,1,1)
        button3=QPushButton("Maximum Value of x",self)
